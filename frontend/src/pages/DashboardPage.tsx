...
export const DashboardPage = () => {
  ...
  const metrics = [["Mi posición", `#${summary.position || "-"}`], ["Mis puntos", summary.totalPoints], ["Aciertos", `${summary.accuracyPercentage}%`], ["Exactos", summary.exactScores], ["Predicciones", summary.predictionsCount], ["Pendientes", summary.pendingMatches], ["Evaluadas", summary.evaluatedPredictions], ["Mejor jornada", summary.bestDay ? `${summary.bestDay.points} pts` : "-"]];
