...
export const ChampionPredictionCard = () => {
  ...
  return <section className="panel bg-[linear-gradient(135deg,_#172554,_#101c2e)]">
    ...
    : <p className="mt-4 text-sm text-slate-300">La predicción cerró al comenzar el Mundial.</p>}
    {!state.prediction && <p className="mt-3 text-xs text-slate-400">Solo se puede guardar una vez. Cierra el {new Date(state.closesAt).toLocaleString()}.</p>}
