...
export const Navbar = () => {
  ...
  const { timeZoneLabel } = useUserDateTime();
  return <header className="border-b border-[#24344d] bg-[#0b1728]/90 backdrop-blur">
    <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-2 px-4 py-3">
      <div className="mr-auto"><p className="font-black text-white">Quiniela Mundial <span className="text-blue-400">2026</span></p><p className="text-xs text-slate-400">{user?.name}{timeZoneLabel && ` · Horario: ${timeZoneLabel}`}</p></div>
